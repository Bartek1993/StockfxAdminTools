...
<body>
    ...
    <%
        ...
        String scan = request.getParameter("scancode");
    try{
    ...
    st.executeUpdate("insert into STPFillets(Name,ScanCode)values('"+product+"','"+scan+"')");
...
<form>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="inputPassword3" placeholder="Scan Code">
    </div>
  </div>
