...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="index.jsp">Edit Users <span class="sr-only">(current)</span></a>
      <a class="nav-item nav-link" href="#">Edit Products</a>
      <a class="nav-item nav-link" href="#">Edit Locations</a>
      <a class="nav-item nav-link" href="#">Edit Batches</a>    
      <a class="nav-item nav-link" href="#">Edit Flocks</a>
    </div>
  </div>
